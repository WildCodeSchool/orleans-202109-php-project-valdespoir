 ...
 */
final class Version20220116110122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partner ADD update_at DATETIME NOT NULL, DROP picture');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partner ADD picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP update_at');
